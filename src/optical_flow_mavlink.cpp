    ...
    while(g_running){
      ...
      ++frame;
        ...
        csv<<now<<','<<ts<<','<<selected_v4l2_ts_ns<<','<<selected_dq_mono_ns<<','
           ...
           <<s.dropout_deep_inliers<<','<<s.dropout_deep_ratio<<','<<s.dropout_deep_ransac_ms<<','
           <<s.dropout_fb_checked<<','<<s.dropout_fb_pass<<','<<s.dropout_fb_ratio<<','
           <<s.dropout_fb_deep_inliers<<','<<s.dropout_fb_ms<<','
